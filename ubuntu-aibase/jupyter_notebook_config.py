...
#  Default: ''
# c.NotebookApp.password = 'argon2:$argon2id$v=19$m=10240,t=10,p=8$RTeE6xEqEM80Opd9yIERug$kKpxQbLyRSoIq5UkmQB2mA'
...
#  Choices: any of ['sha256', 'sha3_256', 'sha384', 'sha224', 'sha1', 'blake2s', 'sha3_512', 'md5', 'sha512', 'sha3_384', 'sha3_224', 'blake2b']
#  Default: 'sha256'
